...
if (Request::isPostRequestMethod()) {
    try {
        ...
        Session::getMultiFactorAuthenticationObject()->verify($code, false);
        Response::getFlashMessagesObject()->addSuccess(tr('Your MFA code has been accepted, you can now continue'));
