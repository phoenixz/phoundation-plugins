 ...
 *
 * This command will split the specified string by the given separator (defaults to ':separator') and find and print the shortest string section with its size
 * in characters
 *
...
$value  = Arrays::getShortestValue($source);
