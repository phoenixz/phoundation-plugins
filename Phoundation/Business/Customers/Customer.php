...
class Customer extends DataEntry
{
    ...
    {
        $definitions->add(DefinitionFactory::newCategoriesId($this))
                    ->add(DefinitionFactory::newCategory($this))
                    ->add(DefinitionFactory::newCompaniesId($this))
                    ->add(DefinitionFactory::newCompany($this))
                    ...
                    ->add(DefinitionFactory::newPhones($this))
